...
# Keep source updates loadable with a `deps.jl` generated by an older Penopt
# build. Rebuilding will replace this fallback with the detected library path.
if !@isdefined(libpennon)
    const libpennon = ""
end
