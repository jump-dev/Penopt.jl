...
"""
function penbmi(
    msizes::Vector{Cint}, x0::Vector{Cdouble}, fobj::Vector{Cdouble},
    q_col::Vector{Cint}, q_row::Vector{Cint}, q_val::Vector{Cdouble}, # Mismatch with doc which starts with q_val, assuming the doc is false
    ci::Vector{Cdouble}, # c vector
    bi_dim::Vector{Cint}, bi_idx::Vector{Cint}, bi_val::Vector{Cdouble}, # b vectors
    ai_dim::Vector{Cint}, ai_idx::Vector{Cint}, ai_nzs::Vector{Cint}, ai_val::Vector{Cdouble}, ai_col::Vector{Cint}, ai_row::Vector{Cint},
    ki_dim::Vector{Cint}, ki_idx::Vector{Cint}, kj_idx::Vector{Cint}, ki_nzs::Vector{Cint}, ki_val::Vector{Cdouble}, ki_col::Vector{Cint}, ki_row::Vector{Cint},
    ...
    ccall((:penbmi, libpenbmi), Cint, (
        ...
        Ptr{Cint}, Ptr{Cdouble}, Ref{Cint}),
        vars, constr, mconstr, msizes,
        fx, x0, u0, uoutput, fobj,
